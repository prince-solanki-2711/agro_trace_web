        ...
        ?>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="view_cart.php?cid=<?php echo $cartid; ?>&dpid=<?php echo $r3[1]; ?>" class="btn-remove shadow-sm" onclick="return confirm('Remove this produce from your basket?')">
            ...
            <div class="row mt-5">
                <div class="col-md-6 offset-md-6">
                    <div class="cart-container p-5 text-end animate__animated animate__fadeInRight">
                        <div class="mb-4">
                            <span class="h5 text-muted d-block mb-2">Total Basket Valuation</span>
                            <span style="font-size: 2.8rem; font-weight: 800; color: var(--agro-leaf); font-family: 'Outfit';">₹<?php echo number_format($tot, 2); ?></span>
                        </div>
                        <a href="view_cart.php?cid=<?php echo $cartid; ?>&ord=x" class="btn-checkout">
                            Place Order Securely <i class="fas fa-truck-fast ms-2"></i>
                        </a>
                        <p class="text-muted small mt-3"><i class="fas fa-shield-check text-success me-1"></i> Every purchase supports verified organic farmers.</p>
                    </div>
                </div>
            </div>
